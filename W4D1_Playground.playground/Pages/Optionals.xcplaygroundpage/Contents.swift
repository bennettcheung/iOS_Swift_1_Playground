 ...
 */
var someVar2: String? = "string value"
someVar2 = nil
 ...
 */
var digitString = "20"
var number:Double? = Double(digitString)
 ...
 */
//let someString2 = "Test"
//let someString = someString2
 ...
 */
//gravityConstant = nil won't let it because it is a constant
...
*/
//: [Next](@next)
let carPrices = ["Mazda3": 50000,
                 "CRV": 60000,
                 "Hummer": 100000]

for (name, price) in carPrices{
  print ("\(name) is $\(price)")
}
